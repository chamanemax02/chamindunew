...
const Testimonials = () => {
    ...
    useEffect(() => {
        ...
        const unsubscribe = onValue(reviewsRef, (snapshot) => {
            ...
            const data = val ? Object.entries(val).map(([id, v]) => ({ id, ...v })) : [];
            ...
            } else { setReviews(approved); }
            setLoading(false);
        });
        return () => unsubscribe();
    }, []);

    const fetchReviews = () => { }; // Handled by onValue
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSubmitted(true);
            showNotification("Review submitted! It will be live after approval.");
