...
const Testimonials = () => {
    ...
    return (
        <div className="container">
            <div className="flex justify-between items-center mb-16 flex-wrap gap-10">
                <div style={{ flex: 1, minWidth: '300px' }}>
                    <h2 style={{ fontSize: 'clamp(2.5rem, 5vw, 4.5rem)', fontWeight: '900', marginBottom: '10px', lineHeight: 1 }}>Client <span style={{ color: 'var(--primary)' }}>Feedback</span></h2>
                    <p style={{ color: 'var(--text-grey)', fontSize: '1.1rem' }}>Hear what our partners have to say about our work.</p>
                </div>
                ...
                >
                    {showForm ? 'Close Editor' : 'Leave a Review'}
                </motion.button>
            </div>
                    ...
                    >
                        {submitted ? (
                            <div className="text-center py-10">
                                ...
                                <h3 style={{ fontSize: '1.5rem', fontWeight: '800' }}>Review Submitted!</h3>
                                <p style={{ color: 'var(--text-grey)' }}>Your feedback is valuable. It will appear after moderation.</p>
                            </div>
                        ) : (
                            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <button type="submit" className="btn-primary" style={{ display: 'flex', gap: '10px' }}>
