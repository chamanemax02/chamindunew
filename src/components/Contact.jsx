...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            params.append('adminEmail', 'ransikachamindu43@gmail.com');
    ...
    return (
        <div className="container" style={{ paddingTop: '50px' }}>
            <h2 className="section-title-p">Contact <span>Me</span></h2>
            ...
            >
                ...
                >
                    <h3 style={{ fontSize: '2rem', fontWeight: '900', marginBottom: '20px' }}>Let's Connect</h3>
                    <p style={{ color: 'var(--text-grey)', fontSize: '1.1rem', marginBottom: '40px' }}>
                        ...
                        I'm always open to discussing new high-impact digital projects.
                    </p>

                    <div className="flex flex-col gap-8">
                        <ContactInfo icon={<Mail color="var(--primary)" />} title="Email" text="ransikachamindu43@gmail.com" />
                        <ContactInfo icon={<Phone color="var(--primary)" />} title="Phone" text="0783314361" />
...
const ContactInfo = ({ icon, title, text }) => (
    <div className="flex gap-4 items-center">
        <motion.div
            animate={{
                rotateY: [0, 360],
                boxShadow: ['0 0 0 rgba(0,255,163,0)', '0 0 20px rgba(0,255,163,0.3)', '0 0 0 rgba(0,255,163,0)']
            }}
            transition={{
                rotateY: { duration: 6, repeat: Infinity, ease: "linear" },
                boxShadow: { duration: 3, repeat: Infinity, ease: "easeInOut" }
            }}
            style={{ width: '50px', height: '50px', background: 'rgba(255,255,255,0.03)', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
        >
            {icon}
        </motion.div>
        <div>
