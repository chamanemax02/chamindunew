...
const Hero = () => {
    return (
        <div className="container" style={{ textAlign: 'center', paddingTop: '100px' }}>
            {/* Main Title Section */}
            <div style={{ minHeight: '280px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                <h2 style={{ fontSize: 'clamp(2rem, 4vw, 3.5rem)', fontWeight: '800', marginBottom: '10px' }}>
                    <TypeAnimation
                        sequence={['Hi, I\'m', 1000]}
                        cursor={false}
                        repeat={0}
                    />
                </h2>
                <h1 style={{
                    ...
                    <TypeAnimation
                        sequence={[
                            1200, // Wait for "Hi, I'm" to finish mostly
                            'Mr Chamindu Ransika',
                            1000
                        ]}
                        wrapper="span"
            ...
            >
                Full-Stack Developer & AI Creative transforming ideas into <br /> exceptional digital experiences.
            </motion.p>

            {/* Counters */}
            <div className="flex justify-center flex-wrap gap-16 md:gap-32 mb-16">
            ...
            >
                ...
                <SocialIcon icon={<Briefcase size={24} />} href="#" />
            </motion.div>
