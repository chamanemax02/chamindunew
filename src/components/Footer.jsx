...
import { Github, Linkedin, Facebook, Heart, Briefcase } from 'lucide-react';
        ...
        <footer style={{
            ...
            <div className="container">
                <div className="grid-3" style={{ marginBottom: '80px', gap: '60px' }}>
                    <div>
                        <h2 className="nav-logo" style={{ marginBottom: '25px', fontSize: '1.6rem' }}>Chamindu <span style={{ color: 'var(--primary)' }}>Ransika</span></h2>
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-col gap-3">
                            <FooterLink to="/home" label="Dashboard Home" />
                            <FooterLink to="/about" label="Professional Brief" />
                            <FooterLink to="/portfolio" label="Work Showcase" />
                            <FooterLink to="/testimonials" label="Client Reviews" />
                        </div>
                    </div>

                    <div className="flex flex-col gap-8">
                        <h4 style={{ fontWeight: '900', fontSize: '1.1rem', letterSpacing: '1px', textTransform: 'uppercase' }}>Professional Network</h4>
                        <div className="flex gap-4">
                            <SocialLink icon={<Linkedin size={20} />} href="https://linkedin.com/in/chaminduransika" />
                            <SocialLink icon={<Github size={20} />} href="https://github.com/chaminduransika" />
                            <SocialLink icon={<Briefcase size={20} />} href="#" />
                        </div>
                        <div>
                            <p style={{ color: '#444', fontSize: '0.85rem', fontWeight: '800', textTransform: 'uppercase' }}>Current Availability</p>
                ...
                <div className="flex justify-between items-center flex-wrap gap-6" style={{ paddingTop: '40px', borderTop: '1px solid rgba(255,255,255,0.03)' }}>
                    <p style={{ fontSize: '0.9rem', color: '#444', fontWeight: '800', letterSpacing: '1px' }}>
                        © 2024 OFFICE OF CHAMINDU RANSIKA
                    </p>
