...
import { Menu, X, LogOut, LayoutDashboard, Github, Linkedin } from 'lucide-react';
                    ...
                    <div className="flex items-center gap-4">
                        <Link to="/home" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '12px' }}>
                            <div style={{
                                ...
                                height: '38px',
                                borderRadius: '10px',
                                background: 'linear-gradient(135deg, var(--primary) 0%, #00b377 100%)',
                                display: 'flex',
                                alignItems: 'center',
                                justifyContent: 'center',
                                overflow: 'hidden'
                            }}>
                                <img src="/profil.png" alt="L" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                            </div>
                            <span className="desktop-only-brand" style={{
                                fontWeight: '900',
                                fontSize: '1.2rem',
                                letterSpacing: '-0.5px',
                                color: '#fff',
                ...
                {mobileMenuOpen && (
                    ...
                    >
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '60px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                <div style={{ width: '36px', height: '36px', borderRadius: '10px', background: 'var(--primary)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    <img src="/profil.png" alt="L" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '10px' }} />
                                </div>
                        ...
                        <div className="flex flex-col gap-6" style={{ overflowY: 'auto', flex: 1 }}>
                            ...
                            <div style={{ marginTop: 'auto', padding: '30px 0', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                                <div className="flex flex-wrap gap-3 mb-8">
                                    {['DEVELOPER', 'DESIGNER', 'CODER', 'AI', 'STUDIO'].map(role => (
                                        <span key={role} style={{
                                            fontSize: '0.6rem',
                                            fontWeight: '900',
                                            padding: '8px 16px',
                                ...
                                <div className="flex gap-8 mb-8">
                                    <a href="https://github.com/chamindu-ransika" target="_blank" rel="noopener noreferrer" style={{ color: '#fff' }}><Github size={24} /></a>
                                    <a href="https://linkedin.com/in/chaminduransika" target="_blank" rel="noopener noreferrer" style={{ color: '#fff' }}><Linkedin size={24} /></a>
                                </div>
