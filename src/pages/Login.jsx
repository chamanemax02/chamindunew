        ...
        <div className="login-page" style={{
            ...
            >
                <div style={{ marginBottom: '40px' }}>
                    <div style={{ width: '60px', height: '2px', background: 'var(--primary)', margin: '0 auto 20px' }}></div>
                    <h1 style={{ fontSize: '2rem', fontWeight: '900', color: '#fff', letterSpacing: '-1px' }}>
                        System Portal
                    </h1>
                    <p style={{ color: 'var(--text-grey)', fontSize: '0.9rem', marginTop: '10px' }}>
